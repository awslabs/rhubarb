...
class Invocations:
    ...
    def _reprompt_for_proper_json(self) -> None:
        ...
        response = self._converse_model_json() if self.use_converse_api else self._invoke_model_json()
            ...
            if stream:
                for event in stream:
                    ...
                    if 'contentBlockDelta' in event:
                        full_response_text = full_response_text + event['contentBlockDelta']['delta']['text']
